    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: "Welcome back to Kejangu!",
        })
      ...
      <Card className="w-full max-w-md relative z-10 shadow-2xl border-0 bg-white/90 backdrop-blur-md">
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 rounded-xl shadow-lg"
              disabled={isLoading}
            >
              {isLoading ? (
